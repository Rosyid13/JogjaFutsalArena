            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nohp" class="col-md-2 col-form-label text-md-end">{{ __('No.HP') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="" cols="30" rows="10" require="">{{ $user->alamat }}</textarea>
